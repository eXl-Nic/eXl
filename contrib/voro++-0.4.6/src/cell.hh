...
namespace voro {
  ...
  struct compute_data
  {
    compute_data();
    ~compute_data();
    void init(unsigned int hx, unsigned int hy, unsigned int hz, unsigned int hxy, unsigned int hxyz);
...
class voronoicell_base {
    ...
    inline compute_data& get_compute_d(){ return m_ComputeData; }
