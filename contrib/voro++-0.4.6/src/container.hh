...
class container_base : public voro_base, public wall_list {
    ...
    void update_box_size(double iMinX, double iMaxX, double iMinY, double iMaxY, double iMinZ, double iMaxZ);
...
class container : public container_base, public radius_mono {
    ...
    bool find_voronoi_cell(compute_data& iData, double x, double y, double z, double &rx, double &ry, double &rz, int &pid);
