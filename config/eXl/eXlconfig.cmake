...
if(${MSVC}) 
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /we4541 /std:c++20")
  if(${EXL_BUILD_SHARED})
...
set(EXL_COMPILER_DEFINITIONS -DNOMINMAX -DBOOST_FLYWEIGHT_EXPLICIT_INIT -DEXL_NAME_EXPLICIT_INIT -D_SILENCE_CXX17_OLD_ALLOCATOR_MEMBERS_DEPRECATION_WARNING)
if(${EXL_TRACE_LEAKS})
set(EXL_COMPILER_DEFINITIONS ${EXL_COMPILER_DEFINITIONS} -DEXL_TRACE_LEAKS)
endif()
...
include(${EXL_ROOT}/config/stb/stb.cmake)
