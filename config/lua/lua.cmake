if(${EXL_BUILD_WITH_LUA})
    ...
    if(${EXL_EXTERNAL_LUA})
        set (LUA_INCLUDE_DIR ${EXL_EXTERNAL_LUA_INCLUDE_DIR})
        set (LUA_LIBRARIES ${EXL_EXTERNAL_LUA_LIBRARIES})
    else()
    ...
    set(EXL_DEPS_INCLUDE ${EXL_DEPS_INCLUDE} ${LUA_INCLUDE_DIR} ${EXL_ROOT}/include/core/lua)
